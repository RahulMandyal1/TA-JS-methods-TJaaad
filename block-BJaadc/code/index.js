...
// console.log(message.slice(  3, 6));
 let a = message.slice(3,6); 

 if(a === "you"){
     console.log("word is you");
 }
 else {
     console.log("word is not you");
 }



// Check and log whether the word from index 7 to 8 is "a" or not
let isA = message.slice(7,8);
isA==="a"?console.log("Character is  a") : console.log("Character is not a ");
// Check and log whether the last 3 character in message is "no!" or not (you can use -3 in slice)
let islast3 = message.slice(-3);
islast3==="no!"?console.log(" yes chacters are no!") : console.log(" no characters are not no! ");
// Check and log whether the last 5 character in message is "no!" or not
let islast5 = message.slice(-5);
islast5==="no!"?console.log(" yes  last five chacters are no!") : console.log(" no  last five characters are not no! ");
...
newMesage = newMessage.replace("still"," ");
...
newMesage = newMessage.replace("thinking","decide");
